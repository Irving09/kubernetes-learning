...
echo "***************************************************"
minikube start --kubernetes-version=v1.19.1 --memory 8192 --cpus 4 --driver hyperkit --extra-config=kubelet.authentication-token-webhook=true --extra-config=kubelet.authorization-mode=Webhook
